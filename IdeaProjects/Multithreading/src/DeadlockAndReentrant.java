...
public class DeadlockAndReentrant{
    public static void main(String[] args) throws InterruptedException {
        DeadlockAndReentrant worker = new DeadlockAndReentrant();
        Cakes bakery1 = new Cakes("Butterscotch", 10000);
        Cakes bakery2 = new Cakes("Pineapple", 20000);
